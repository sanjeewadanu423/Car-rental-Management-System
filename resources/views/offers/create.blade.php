         ...
         <div class="row">
		    ...
		    <div class="col-xs-12 col-sm-12 col-md-12">
		        <div class="form-group">
		            ...
		            <textarea class="form-control" style="height:150px" name="offer_descrip" placeholder="description"></textarea>
		        </div>
		    </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
		        <div class="form-group">
		            <strong>Offer Coupon:</strong>
		            <input type="text" name="coupon" class="form-control" placeholder="00112233">
		        </div>
		    </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
		        <div class="form-group">
